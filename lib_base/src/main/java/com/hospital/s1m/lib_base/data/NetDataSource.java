...
import com.hospital.s1m.lib_base.constants.ParamKey;
...
import com.hospital.s1m.lib_base.entity.OrderBy;
import com.hospital.s1m.lib_base.entity.QueryParameter;
import com.hospital.s1m.lib_base.entity.WhereClause;
import com.hospital.s1m.lib_base.listener.MyDownloadListener;
import com.hospital.s1m.lib_base.listener.MyUploadListener;
import com.hospital.s1m.lib_base.listener.ResponseListener;
import com.hospital.s1m.lib_base.utils.HashUtils;
...
public class NetDataSource {
    ...
    public static <T> void post(Object tag, String url, List<WhereClause> whereList, List<OrderBy> orderList,
                                String viewName, ResponseListener<T> listener) {
        String whereStr = "";
        if (whereList != null) {
